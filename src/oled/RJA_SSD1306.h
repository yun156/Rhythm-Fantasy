// RJA_SSD1306.h  (minimal for Rhythm-Fantasy)
#ifndef RJA_SSD1306_H_
#define RJA_SSD1306_H_
...
public:
    ...
    void setDisplayOffset(uint8_t ofs);
    void setStartLine(uint8_t line);

    void pixel(int x, int y, bool colour, bool locked = 0);
